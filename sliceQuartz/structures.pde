...
class SliceBox {
  ...
  void createOcathedronWithCenterAndSize(float x, float y, float z, float width, float height, float depth) {
  ...
  void create(float[][] vertexArray, int[][] faceArray) {
    ...
    createRaw(vertexArray, faceArray, halfedgePairArray);
  }
  ...
  void slice(Plane P, float offset) {
